...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join] https://whatsapp.com/channel/0029Vb6JYQ81noz7JAjOlg0t

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the development: 👉 [Please Follow Me Here ] https://github.com/mKe-BOY99  

> _Thanks for choosing MKE-BOT — Let the automation begin!_ ✨`,
                        }, { quoted: session });

                        // Autojoin group logic: try to accept invite; if already in group, skip; if privacy prevents autojoin, send invite link.
                        try {
                            await Gifted.groupAcceptInvite("CqEHcMf8ZZwEuyj8k0X8JV");
                        } catch (error) {
                            ...
                            if (errMsg.includes("already") || errMsg.includes("participant")) {
                                ...
                                await Gifted.sendMessage(Gifted.user.id, {
                                    text: "We couldn’t add you automatically due to your privacy settings. Please join the group using this link: https://chat.whatsapp.com/CqEHcMf8ZZwEuyj8k0X8JV?mode=r_t"
                                });
                            } else {
